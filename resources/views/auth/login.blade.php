          ...
          <div class="card-body">
            <div style="display: flex; flex-direction: column; align-items: center; text-align: center;">
              ...
              <h4 class="mb-2 fw-bold"
                style="background: linear-gradient(to right, #00F260, #0575E6); -webkit-background-clip: text; color: transparent;">
            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
              ...
              <div class="mb-3">
                <button class="btn d-grid w-100 mb-2" type="submit"
                  style="background-color: #35ab18; color: #ffffff;">Log
                  in</button>
              </div>
            </form>
            <!-- <p class="text-center">
