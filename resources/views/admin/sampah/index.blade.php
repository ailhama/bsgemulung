  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal"><i
          class="fas fa-plus"></i> Tambah Sampah
      </button>
            ...
            <table class="table table-hover" id="myTable">
              ...
              <tbody class="table-border-bottom-0">
                ...
                <tr>
                  ...
                  <!-- <td><a target="_blank" href="/storage/gambar/{{ $data->gambar }}">{{ $data->gambar }}</a></td> -->
                  <!-- <td>
                  ...
                  <!-- <td>
                    <a data-confirm-delete="true" href="/admin/sampah/{{ $data->id }}"
                      class="btn btn-danger btn-sm">Batalkan</a>
                  </td> -->
                  <td>
                    <!-- <a href="" class="btn btn-warning btn-sm">Edit</a> -->
                    <a href="{{ route('sampah.edit', $data->id) }}" class="btn btn-warning btn-sm"><i
                        class="fas fa-edit"></i> Edit</a>
                    <a data-confirm-delete="true" href="/admin/sampah/{{ $data->id }}" class="btn btn-danger btn-sm"><i
