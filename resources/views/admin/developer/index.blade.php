        ...
        <div class="row" data-aos="fade-left">
            ...
            <div class="col-lg-4 col-md-6 text-center mx-auto">
                <div class="member" data-aos="zoom-in" data-aos-delay="100">
                    <div class="pic"><img src="{{ asset('assets/img/dafi.jpg') }}" class="img-fluid" alt="" style="height: 300px;">
                    </div>
                    <div class="pagetitle">
            ...
            <div class="col-lg-3 col-md-6 mt-5 mt-lg-0 text-center mx-auto">
                <div class="member" data-aos="zoom-in" data-aos-delay="200">
                    <div class="pic"><img src="{{ asset('assets/img/andika.jpg') }}" class="img-fluid" alt="" style="height: 300px;">
                    </div>
                    <div class="pagetitle">
            ...
            <div class="col-lg-3 col-md-6 mt-5 mt-lg-0 text-center mx-auto">
                <div class="member" data-aos="zoom-in" data-aos-delay="300">
                    <div class="pic"><img src="{{ asset('assets/img/ilham.jpg') }}" class="img-fluid" alt="" style="height: 300px;">
                    </div>
                    <div class="pagetitle">
