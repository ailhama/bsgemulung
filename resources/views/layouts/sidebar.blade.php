<aside id="layout-menu" class="layout-menu menu-vertical menu  bg-primary">
  <div class="app-brand demo">
    <img src="{{ asset('assets/img/logo ppmt1.jpg') }}" alt="logo-ppmt-banyuwangi"
      style="width: 200px; margin-bottom: 10px; border-radius: 0%;">
  </div>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ Request::is('admin/sampah') ? 'active' : '' }}">
      <a href="/admin/sampah" class="menu-link">
        <i class="menu-icon tf-icons bx bx-box"></i>
        <div data-i18n="Without menu">Input Data Sampah</div>
      </a>
    </li>
    @endrole
